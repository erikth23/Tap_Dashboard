...
const FormValidations = (props) => {
  ...
  function handleSubmit(e){
    ...
    if( city === "" ) { setcity(false) }
      else { setcity(true) }

    if( stateV === "" ) {  setstateV(false) }
      else {  setstateV(true) }
                            ...
                            <Col xl="6">
                                <Card>
                                    <CardBody>
                                        ...
                                        <form className="needs-validation" method="post" id="tooltipForm" onSubmit={(e) =>  { handleSubmit(e) } }>
                                            <Row>
                                                <Col md="4">
                                                ...
                                                <Col md="4">
                                                    <FormGroup className="position-relative">
                                                        ...
                                                        <Input type="text" className="form-control" id="validationTooltip02" placeholder="Last name" onChange={(event) => changeHandeler(event,"validate2")}/>
                                                        <div className={lnm === true ? "valid-tooltip" : "invalid-tooltip"} name="validate" id="validate2">
                                                ...
                                                <Col md="4">
                                                    <FormGroup className="position-relative">
                                                        ...
                                                        <div className="input-group">
                                                            ...
                                                            <Input type="text" className="form-control" id="validationTooltipUsername" placeholder="Username" onChange={(event) => changeHandeler(event,"validate3")}/>
                                                            <div className={unm === true ? "valid-tooltip" : "invalid-tooltip"} name="validate" id="validate3">
                                            ...
                                            <Row>
                                                <Col md="6">
                                                    <FormGroup className="position-relative">
                                                        ...
                                                        <Input type="text" className="form-control" id="validationTooltip03" placeholder="City" onChange={(event) => changeHandeler(event,"validate4")}/>
                                                        <div className={city === true ? "valid-tooltip" : "invalid-tooltip"} name="validate" id="validate4">
                                                        {city === true ? "Looks good!" : "Please choose a unique and valid username.Please provide a valid city."}
                                                        </div>
                                                    </FormGroup>
                                                </Col>
                                                <Col md="6">
                                                    <FormGroup className="position-relative">
                                                        ...
                                                        <Input type="text" className="form-control" id="validationTooltip04" placeholder="State" onChange={(event) => changeHandeler(event,"validate5")} />
                                                        <div className={stateV === true ? "valid-tooltip" : "invalid-tooltip"} name="validate" id="validate5">
