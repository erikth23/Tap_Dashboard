    ...
    <header id="page-topbar">
      <div className="navbar-header">
        <div className="d-flex">
          ...
          <Dropdown className="dropdown-mega d-none d-lg-block ml-2" isOpen={megaMenu} toggle={() => {
              setmegaMenu(!megaMenu)
            }}>
            <DropdownToggle className="btn header-item waves-effect" caret="caret" tag="button">
              {props.t('Mega Menu')}
              {" "}
        ...
        <div className="d-flex">
          <div className="dropdown d-inline-block d-lg-none ml-2">
            ...
            <div className={search
                ...
                : "dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"} aria-labelledby="page-header-search-dropdown">
          ...
          <Dropdown className="d-none d-lg-inline-block ml-1" isOpen={socialDrp} toggle={() => {
              setsocialDrp(!socialDrp);
            }}>
            <DropdownToggle className="btn header-item noti-icon waves-effect" tag="button">
              <i className="bx bx-customize"></i>
            </DropdownToggle>
            <DropdownMenu className="dropdown-menu-lg" right="right">
