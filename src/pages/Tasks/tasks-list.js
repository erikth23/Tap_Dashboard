      ...
      <Container fluid="fluid">
        ...
        <Row>
          <Col lg={8}>
            <Card>
              <CardBody>
                <CardTitle className="mb-4">Example
                </CardTitle>
                  ...
                  <table className="table table-nowrap table-centered mb-0">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Create a Skote Dashboard UI</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
                      ...
                      <tr>
                        <td>
                          <div className="custom-control custom-checkbox">
                            <input type="checkbox" className="custom-control-input" id="customCheck2" defaultChecked="defaultChecked"/>
                            <label className="custom-control-label" htmlFor="customCheck2" onClick={() => {
                                setchk1(!chk1)
                              }}></label>
                          </div>
                        </td>
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Create a New Landing UI</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
                      ...
                      <tr>
                        ...
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Create a Skote Logo</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
                    ...
                    <tbody>
                      <tr>
                        <td style={{
                          ...
                          <div className="custom-control custom-checkbox">
                            <input type="checkbox" className="custom-control-input" id="customCheck4" defaultChecked="defaultChecked"/>
                            <label className="custom-control-label" htmlFor="customCheck4" onClick={() => {
                                setchk2(!chk2)
                              }}></label>
                          </div>
                        </td>
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Brand logo design</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
                      ...
                      <tr>
                        ...
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Create a Blog Template UI</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
                  ...
                  <table className="table table-nowrap table-centered mb-0">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Redesign - Landing page</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
                      ...
                      <tr>
                        <td>
                          <div className="custom-control custom-checkbox">
                            <input type="checkbox" className="custom-control-input" id="customCheck7" defaultChecked="defaultChecked"/>
                            <label className="custom-control-label" htmlFor="customCheck7" onClick={() => {
                                setchk3(!chk3)
                              }}></label>
                          </div>
                        </td>
                        <td>
                          <h5 className="text-truncate font-size-14 m-0">
                            <Link to="#" className="text-dark">Multipurpose Landing</Link>
                          </h5>
                        </td>
                        <td>
                          <div className="team">
          ...
          <Col lg={4}>
            <Card>
              <CardBody>
                <CardTitle className="mb-4">Tasks
                </CardTitle>
            ...
            <Card>
              <CardBody>
                <CardTitle className="mb-4">Recent Tasks
                </CardTitle>
