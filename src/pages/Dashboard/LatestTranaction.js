      ...
      <CardBody>
        ...
        <div className="table-responsive">
          <table className="table table-centered table-nowrap mb-0">
            ...
            <tbody>
              {
                transactions.map((transaction, key) => <tr key={"_tr_" + key}>
                  <td>
                    <div className="custom-control custom-checkbox">
                  ...
                  <td>
                    <Badge className={"font-size-12 badge-soft-" + transaction.badgeClass} color={transaction.badgeClass} pill="pill">{transaction.paymentStatus}</Badge>
                  </td>
                  <td>
